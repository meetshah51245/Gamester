...
<li class="level0 nav-3 active level-top parent"><a href="#" class="level-top"><span>Platform</span></a>
	<ul class="level0">
...
function filter() {
  ...
  xhttp.open("POST", "PlatformFilter", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send("ajax=filter&size="+s+"&sortBy="+y+"&platform=<%= title%>");
  return false;
}
</script>
...
function loadDoc() {
  ...
  xhttp.open("POST", "PlatformFilter", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send("ajax=more&size="+size+"&sortBy="+y+"&platform=<%out.print(title);%>");
  return false;
}
var timeOut;
