...
<ul id="nav" class="sf-menu">
	<li class="level0 nav-1 first active level-top"><a href="${pageContext.request.contextPath}/Game" class ="level-top"><span>Games</span></a>
	</li>
...
function loadDoc() {
  ...
  xhttp.open("POST", "Check", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send("ajax=more&size="+size+"&sortBy="+y);
  return false;
}
