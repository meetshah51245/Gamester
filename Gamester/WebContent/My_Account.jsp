...
<body class="ps-static  customer-account-edit" onload="checkCookie1()">
...
<li class="last"><a href="<% if(ref!= null)
{
    ...
    out.print("http://livedemo00.template-help.com/magento_52165/customer/account/login/");
}
...
<li class=" last"><a href="<% if(ref != null)
{
    ...
    out.print("http://dgdfgs/customer/account/login/");
}
%>" title="Log In" ><% if(logout != null)
{
    out.print(logout);
...
<form action="Account?form=edit" method="post" id="form-validate" autocomplete="off">
<div class="fieldset">
...
<div class="input-box">
<input type="text" id="firstname" name="firstname" value="<%=info[0] %>" title="First Name" maxlength="255" class="input-text required-entry"/>
</div>
</div>
<div class="field name-lastname">
<label for="lastname" class="required"><em>*</em>Last Name</label>
<div class="input-box">
<input type="text" id="lastname" name="lastname" value="<%=info[1] %>" title="Last Name" maxlength="255" class="input-text required-entry"/>
</div>
</div>
</div>
</li>
...
<div class="input-box">
<input type="text" name="email" id="email" value="<%=info[2] %>" title="Email Address"  class="input-text required-entry validate-email" readonly/>
</div>
</li>
<li class="control">
