...
<li class="level0 nav-4 active level-top"><a href="Hardware?action=hardware" class="level-top"><span>Hardware</span></a>
</li> 
...
function filter() {
  ...
  xhttp.open("POST", "Hardware", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send("action=filter&size="+size+"&sortBy="+y);
  return false;
}
</script>
...
%>
<tr>
<td style="padding: 15px;"><a href="#" title="<%=item[1] %>" class="product-image" itemprop="url"><img data-src="<%=item[3] %>" width="180" height="180" class="lazy" alt="<%=item[1] %>" src="image_placeholder.jpg"/></a>
...
<% if(item1 !=null){
 %>
 <a href="#" title="<%=item1[1] %>" class="product-image" itemprop="url"><img data-src="<%=item1[3] %>" width="180" height="180" class="lazy" alt="<%=item1[1] %>" src="image_placeholder.jpg"/></a>
 <input type='hidden'></input>
 <%} %>
 </td>
...
<%  
 if(item2 != null){
	%>
<a href="#" title="<%=item2[1] %>" class="product-image" itemprop="url"><img data-src="<%=item2[3] %>" width="180" height="180" class="lazy" alt="<%=item2[1] %>" src="image_placeholder.jpg"/></a>
<input type='hidden'></input>
<%} %>
</td>
</tr>
...
<script type="text/javascript">decorateGeneric($$('.grid_row'), ['odd','even','first','last'])</script>
...
function loadDoc() {
  ...
  xhttp.open("POST", "Hardware", true);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send("action=more&size="+size+"&sortBy="+y);
  return false;
}
