...
<form action="LoginForm" method="post" id="login-form">
<input name="form_key" type="hidden" value="USk4OaY0ifcr9SPL"/>
<div class="col2-set">
<div class="wrapper">
...
<div class="input-box">
<input type="email" name="username" value="" id="email" class="input-text required-entry validate-email" title="Email Address"/>
...
<div class="buttons-set">
<button type="button" title="Create an Account" class="button" onclick="window.location='http://chgvhjvj/customer/account/create/';"><span><span>Create an Account</span></span></button>
</div>
</div>
</div>
</div>
